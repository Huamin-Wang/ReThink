...
exports.main = async (event) => {
  ...
  try {
    // 构造提示词，要求返回数组
    const prompt = `你是消费分类助手。请根据用户的消费描述，从以下类别中选择最合适的分类，并提取金额。
严格返回 JSON 数组格式，例如：
[{"category":"餐饮","amount":200,"description":"昨天吃火锅"},
 {"category":"交通","amount":30,"description":"今天打车"},
 {"category":"购物","amount":300,"description":"买衣服"}]
